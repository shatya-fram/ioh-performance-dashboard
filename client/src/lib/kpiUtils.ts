...
export const KPI_FIELDS: Record<string, { label: string; divisor: number; unit: string; category: string }> = {
  ...
  Subs_RGU90D:       { label: "Subs RGU 90D",        divisor: 1e6,  unit: "Mn Subs", category: "subscriber" },
  Subs_RGU30D:       { label: "Subs RGU 30D",        divisor: 1e6,  unit: "Mn Subs", category: "subscriber" },
